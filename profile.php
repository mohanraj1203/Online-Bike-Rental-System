...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,Aadhar=:Aadhar,pan=:pan,license=:license,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="Aadhar" value="<?php echo htmlentities($result->Aadhar);?>" id="phone-number" type="text" >
            </div>
            <div class="form-group">
              <label class="control-label">PAN Number</label>
              <input class="form-control white_bg" name="pan" value="<?php echo htmlentities($result->pan);?>" id="phone-number" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Driving License Number</label>
              <input class="form-control white_bg" name="license" value="<?php echo htmlentities($result->license);?>" id="phone-number" type="text">
            </div>
            <div class="form-group">
